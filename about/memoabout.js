...
function bgParallax() {
    var e = event.target;
    var img = document.getElementById('bgIllus');

    const scrollPercent = (e.scrollTop / (e.scrollHeight - e.clientHeight));
    const transformNum = 50 * scrollPercent;
    img.style.transform = 'translateY(-'+ transformNum+ '%)';
}
...
document.getElementById('main').addEventListener('scroll', bgParallax);